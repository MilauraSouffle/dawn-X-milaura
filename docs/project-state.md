> Tactile et cadrages, 2026-09-05 15:48 CEST : correctif du glissement de l'annuaire LIVE sur `190430282075`, integration `3074ae39`, pullback 3/3 et gestes simules 360/390/430 conformes. Controle de l'iPhone physique demande a Patrice. Les cadrages accueil/annuaire/cartes produit sont PRETS EN PREVIEW PRIVEE `200974958939`, commit `d7e8f7af` sur `codex/milaura-touch-framing-20260905`, pullback 5/5, recette 390/1440 et Theme Check 0 erreur/16 avertissements historiques. GO visuel avant integration/publication des trois CSS. [Correctif tactile](checkpoints/2026-09-05-1537-stone-touch-fix.md). Rapport photo dans le worktree reserve : `docs/audits/2026-09-05-photo-framing-preview.md`.
