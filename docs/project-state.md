> Menu Guides, 2026-09-12 19:29 CEST : `Trouver votre pierre`, `Atlas des pierres` et `Entretien des pierres` sont maintenant regroupes en tete du menu `Guides` public, sur desktop et mobile. Commit fonctionnel `9acd623a`, integration poussee, fichier unique deploye sur `190430282075`, pullback identique. QA publique 1440/390 : rendu lisible, trois destinations correctes et journal navigateur vide. Les autres entrees, le footer, le diagnostic et les Ads restent inchanges. [Checkpoint](checkpoints/2026-09-12-1929-guides-menu-stone-pages-live.md).

> Actifs proprietaires pierre, 2026-09-12 19:12 CEST : le selecteur, la matrice d entretien et l atlas sont publics sur leurs trois URL canoniques. Le Hero de `/pages/pierres-de-naissance` montre les trois bracelets valides. Vingt fichiers exacts sont live sur `190430282075`, pullback `20/20` identique. Les quatre pages repondent `200`, les trois nouvelles URL figurent dans le sitemap, et la QA 390/1440 confirme Heroes responsive, H1 uniques, interactions, absence de debordement et journal navigateur vide. Source et integration etaient a `6f069db8` avant la cloture documentaire. Etude annuelle et doublon naissance restent retires ; le quiz Ads lead-gen est un chantier distinct. [Checkpoint](checkpoints/2026-09-12-1912-owned-stone-assets-live.md).
