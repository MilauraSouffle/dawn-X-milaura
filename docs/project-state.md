> Swipe explicite, 2026-09-05 18:31 CEST : PREVIEW, retour iPhone attendu. Patrice confirme que le lot natif precedent reste bloque meme via le lien neuf, avec seulement un mouvement vertical. Source `23b6b565`, branche `codex/milaura-stone-pointer-swipe-20260905`, deux assets en preview `200974958939`, pullback 2/2 identique. Pilotage horizontal Pointer Events, defilement vertical preserve, design strictement conserve, anciens scroll/scroll-snap retires. Recette tactile simulee sur 13 rangees et cinq largeurs conforme ; WebKit teste avec pointeur souris, aucun iPhone physique teste par Codex. Theme Check 0 erreur/16 avertissements historiques. Pas de nouveau deploy live dans ce lot ; version native precedente encore publique. Worktree conserve pour le retour utilisateur. Checkpoint dans la branche source : `docs/checkpoints/2026-09-05-1829-stone-pointer-swipe-preview.md`.
