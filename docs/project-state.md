# Meta Religion : passation prioritaire du 2026-09-09

Dernier constat direct Meta le 2026-09-08 : dataset `milaurashopify 830428425991691`, Religion / Examen refuse (decision du 7 septembre a 19:01), nouveau recours desactive. Dossier prioritaire `903464745887340` Recu / Actif, PDF joint a 17:23 ; aucun humain ni reclassement confirme. Le profil Karine ZA affiche aucun probleme publicitaire, contrairement au premier diagnostic retracte de l'IA. Le controle Shopify confirme le bon dataset. Patrice autorise les relances techniques et veut reprendre dans une session fraiche. Aucun nouveau controle Meta ou lancement pendant cette cloture. [Handoff, IDs, preuves, autorisations et prompt](checkpoints/2026-09-09-1615-meta-religion-human-support-handoff.md).

L'automatisation `suivi-examen-meta-milaura` est ACTIVE sur une autre tache ; verifier l'existant avant tout doublon. Contenu organique / concours a choisir avec Patrice. Le concours a ete reporte au 2026-09-09 a 20:00, fermeture le 19 a 19:59 et tirage le 20 a 12:00 selon son checkpoint ; la premiere tranche payante conseillee reste 30 EUR au total sur 48 heures, non lancee par cette session. Branche documentaire isolee, checkout principal sale preserve, aucune fusion ni modification live.
