...
- Checkout d integration aligne avec `origin/codex/milaura-integration` au commit fonctionnel `3634c70e` avant la cloture documentaire, mais sale avec des changements documentaires et exports concurrents preserves. Ne pas nettoyer ou ajouter globalement par deduction.
