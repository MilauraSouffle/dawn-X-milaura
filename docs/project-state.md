...
> Hero accueil, 2026-09-14 15:03 CEST : LIVE VERIFIE. Le Hero aigue-marine `L harmonie parfaite.` est actif sur `190430282075`, avec son H1 en Dancing Script. L ancien Hero avec Chloé est conserve comme section independante nommee exactement `HERO CHLOE` dans l editeur Shopify et peut etre ajoute a une autre page sans toucher a l accueil. Commits `509ed8e2`, `c29ae504`, `e60effeb` et `a956bc69` pousses sur la branche source et `codex/milaura-integration`. Theme Check : 0 erreur, 16 avertissements historiques. Pullbacks Hero actif et `HERO CHLOE` identiques, ce dernier SHA-256 `c125edbd90c4559a4895ce2d902075683cfbcff79ae95c8101f0a2d7e661ffd2`. Reprise : `Creons cette page et reutilisons le HERO CHLOE.` [Checkpoint courant](checkpoints/2026-09-14-1503-aquamarine-hero-live-handoff.md).

> Cloture certificats, bandeau, checkout et Hero, 2026-09-13 11:56 CEST : SESSION ARRETEE SUR DEMANDE DE PATRICE. La page certificats et son lien footer, le bandeau rose des avantages et le Hero mobile final restent live sur `190430282075`. Hero integre et pousse au commit `19fbc918`, pullback identique et QA mobile 430 / bureau 1440 conforme. Le profil checkout actif `MilAura Checkout UX 2026-09-13`, ID `9395241307`, est conserve sans nouvelle sauvegarde. Le checkout sera repris dans une session dediee, d abord en lecture seule. Le checkout principal local reste tres sale et 66 commits derriere la branche distante : aucun nettoyage ni staging large. Le lot certificats live reste a reconcilier dans Git sans reecriture destructive de l historique. [Checkpoint courant](checkpoints/2026-09-13-1156-certificats-checkout-hero-handoff.md).

> Correctif CTA multilignes, 2026-09-13 08:15 CEST : LIVE VERIFIE. Le soulignement ligne par ligne des actions sous les cartes des trois guides a ete remplace par un unique filet sous le bloc complet. Fichier CSS unique publie sur `190430282075`, pullback identique SHA-256 `bc3811ea7dae56912179ecf5f3f5c3823f92cb87c3995086a7c76059f44f2ef5`. QA publique 390 et 1028 px, trois guides, collection Tous les bijoux et hub Bijoux par pierre : theme attendu, aucune double ligne, aucune erreur ni debordement. Commit fonctionnel `725cf31e`. [Checkpoint](checkpoints/2026-09-13-0815-multiline-guide-cta-live.md).

> Actifs pierre et menu Guides, handoff du 2026-09-12 19:42 CEST : LOT FERME, INTEGRE, POUSSE ET LIVE VERIFIE. Trois pages publiques, Heroes valides, page canonique Pierres de naissance a trois bracelets et trois nouveaux liens regroupes en tete de `Guides` sur desktop et mobile. Theme `190430282075`, push initial cible 20 fichiers puis correctif navigation limite a un snippet, deux pullbacks identiques. Source fonctionnelle et integration a `a42614c7` avant la cloture documentaire. QA publique 390/1440, interactions, destinations, sitemap et journal navigateur conformes. Etude annuelle et doublon naissance restent retires. Le quiz Ads lead-gen est le prochain chantier distinct, sans implementation, collecte, remise, automatisation, campagne ou budget autorise dans cette session. [Handoff final](checkpoints/2026-09-12-1942-owned-stone-pages-session-handoff.md).
...
Le nouveau Hero mode est live et valide par Patrice sur le theme public `190430282075`. Chloe porte quatre familles de bijoux a une echelle coherente. Le surtitre `Bijoux en pierres naturelles` est en aigue-marine, le H1 est fixe sur `Vos emotions` puis `ont du style.`, la phrase de choix est en Dancing Script et le CTA editorial conduit vers tous les bijoux. Source fonctionnelle `ee2d4eff`, documentation de release `f2832f63`, branche source et `codex/milaura-integration` poussees. Pullback Shopify `3/3` identique, QA publique `360/390/430/1440`, clic CTA, absence de debordement et journal navigateur verifies. Le lot est ferme et ne doit pas etre redeploye par deduction. [Handoff final](checkpoints/2026-09-09-1326-home-hero-fashion-handoff.md).

# SEO, performance et autorite : live verifie le 2026-09-08 19:16 CEST

Les trois taches demandees sont executees et verifiees. Le lot performance de sept fichiers est live sur le theme `190430282075`, pullback `7/7` identique, puis le preload responsive du Hero a ete pousse et relu identique dans `layout/theme.liquid`. QA publique mobile/desktop et panier conformes. Le socle SEO, les metadonnees, redirections, H1 et `noindex,follow` de `/blogs/infos` sont controles. Cent cibles d autorite sont classees et la premiere vague est partie : neuf messages sans rejet immediat, FemininBio rejete sur ses deux adresses publiques. PageSpeed final : mobile `70`, bureau `89`, SEO `100`; face au run avant lot, le mobile gagne cinq points, `0,3 s` de LCP, `0,6 s` de FCP et `100 ms` de TBT. Le LCP froid reste un chantier, tandis que les Core Web Vitals reels restent bons. Ads non lancees : stock, marge, Purchase Pixel/CAPI et budget restent quatre gates. [Checkpoint](checkpoints/2026-09-08-1916-seo-performance-authority-live.md) et [audit](audits/2026-09-08-seo-performance-authority.md).
...
Patrice a valide la preview puis donne le GO commit, push et live. La collection publique `/collections/bijoux-pierres-naturelles`, ID Shopify `660994851163`, utilise maintenant le template `milaura-all-jewelry` sur le theme live `190430282075`. Hero editorial bureau/mobile, cinq entrees par type, lien vers le choix par pierre, filtres et grille sont actifs. La phrase `Affinez la selection par pierre, disponibilite ou prix.` a ete retiree avant publication. Source `86c90ea9`, integration `91596690`, pullback live 5/5 identique. URL publique, H1 unique, cinq cartes, liens, rail mobile, absence de debordement a 390/1440 px et journal navigateur vide verifies. [Checkpoint live](checkpoints/2026-09-07-1828-all-jewelry-landing-live-handoff.md). Lot ferme ; ne pas redeployer par deduction.
...
> Swipe natif, 2026-09-05 17:55 CEST : LIVE sur demande de Patrice, en complement des fleches, de la barre et du compteur sous les cartes. Design conserve ; ancien translateX retire. Source `a9e4dcb5`, integration `e2236d13` poussees ; deux assets sur `190430282075`, pullback 2/2 identique. Gestes tactiles simules sur treize rangees, CPU x4, mouvement vertical, clavier et commandes conformes ; rendu Chromium 360/390/430/768/1440 et WebKit 390/1440 identique a la base validee. Aucun iPhone physique teste. Theme Check 0 erreur/16 avertissements historiques. Worktree propre retire, reservations liberees. [Checkpoint courant](checkpoints/2026-09-05-1747-stone-native-swipe.md).

> Navigation sous les cartes, 2026-09-05 17:38 CEST : correction LIVE apres rejet des chevrons lateraux par Patrice. Fleches cliquables 44 px, barre avec segment mobile et compteur reunis sous chaque rangee. Ancien DOM superpose, styles, observateur et animation retires. Source `29fb3ec9`, integration `7f3b20eb` poussees ; trois fichiers live sur `190430282075`, pullback 3/3 identique. Recette publique 360/390/430/768/1440 et treize rangees conforme ; dimensions et styles des 39 cartes et desktop preserves. Worktree propre retire, reservations liberees. [Checkpoint courant](checkpoints/2026-09-05-1733-stone-bottom-navigation.md).

> Fleches mobiles, 2026-09-05 17:11 CEST : dernier polish demande apres observation de Tiffany et Van Cleef & Arpels. Chevrons fins sans boite, dans les marges hors des photos, cibles invisibles 44 px. Source `085465e8`, integration `fe4fe056` poussees ; deux fichiers live sur `190430282075`, pullback 2/2 identique. Cartes compactes et desktop inchanges. Recette publique 360/390/430/768/1440, treize rangees et appui direct sur les chevrons conformes. Preview panier non touchee. [Checkpoint courant](checkpoints/2026-09-05-1708-stone-arrow-polish.md).

> Cartes mobiles, 2026-09-05 16:53 CEST : format compact precedent retabli apres rejet de l'agrandissement par Patrice, qui confirme le desktop. Source `85737031`, integration `98e158d6` poussees, CSS unique live sur `190430282075`, pullback identique. Fleches et cadrages conserves. Comparaison publique 360/390/430/749 identique au format mobile precedent ; desktop 768/1440 inchange. Treize rangees et clavier verifies. Preview panier non touchee. [Checkpoint courant](checkpoints/2026-09-05-1651-stone-mobile-compact.md).

> Navigation des pierres, 2026-09-05 16:38 CEST : LIVE sur `190430282075`, source `c6ddfede`, integration `7c22cac0`, pullback 3/3 identique. Le swipe abandonne sur demande de Patrice est remplace par des fleches translucides sur les photos, avec une indication animee limitee et le compteur dessous. Anciens mecanismes de glissement retires. Aigue-marine reintegree a la grille desktop reguliere ; cadrages valides conserves. Recette publique 360/390/430/768/1440, treize rangees, clavier, mouvement reduit et sans JS conformes ; Theme Check 0 erreur/16 avertissements historiques. Worktree termine retire, branche conservee, checkout concurrent preserve. [Checkpoint courant](checkpoints/2026-09-05-1635-stone-arrow-navigation.md).

> Cadrages et fluidite, 2026-09-05 16:13 CEST : LIVE VERIFIE sur `190430282075`. Cadrages valides par Patrice, source `d7e8f7af`, integration `911e206d`. Premier glissement juge insuffisamment fluide par Patrice, remplace par le geste et l'inertie natifs, source `6ba3120e`, integration `34bf06ca`. Pullback final 4/4 identique ; gestes publics 360/390/430 avec CPU x4, zero pilotage JS du scroll pendant le toucher ; cadrages 390/1440 et Theme Check 0 erreur/16 avertissements historiques. Preview egalement actualisee. Ressenti iPhone physique encore a confirmer par Patrice. Branche source conservee, worktree integre retire proprement ; travaux concurrents preserves. [Checkpoint courant](checkpoints/2026-09-05-1613-framing-native-swipe-live.md).

> Annuaire par pierre, 2026-09-05 10:55 CEST : LIVE VERIFIE sur `190430282075`. Les 39 cartes ouvrent leurs landings dediees sans `view` ; 40 pages avec Jaspe rouge historique. Dix affectations et trente publications Boutique en ligne executees. Recherche retiree, treize rangees de trois cartes maximum sur mobile. Pullback 49/49, controles publics et responsive 390/1440 conformes. Integration `3d29f3a8`, compteurs `3492023f`. Trois Boho DRAFT dans la tache catalogue : compteurs Quartz rose 10, Aventurine 6, Obsidienne 4, a revoir lors de leur reactivation. [Release par pierre](checkpoints/2026-09-05-1055-stone-directory-live.md).
...
- `docs/checkpoints/2026-09-04-1738-inventory-legacy-retirement-handoff.md`
...
> Correctif Hero accueil, 2026-09-14 15:20 CEST : le domaine public sert de nouveau le Hero aigue-marine `L harmonie parfaite.` avec les assets `milaura-hero-bijoux-pierres-naturelles-obsidienne-sodalite-*.webp`, son alt descriptif, son CTA collection et un unique H1. La section Sodalite est maintenant un H2. Sur instruction explicite de Patrice, `HERO CHLOE` et ses assets sont retires du source et ne sont plus references. Leur suppression distante doit passer par une action Shopify Admin fichier par fichier : Shopify CLI ne garantit pas une suppression ciblee sans risque de retrait plus large.
