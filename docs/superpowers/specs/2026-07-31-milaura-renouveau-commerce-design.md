...
Statut : direction commerciale et architecture homepage validees par Patrice. Panier deploye et valide. Lots homepage H1A et H1B publies sur le live et techniquement verifies.
...
## 2.2 Architecture homepage validee le 2026-08-05
...
Le hero ne doit pas envoyer prematurement le visiteur hors de la homepage. Son CTA unique est `Voir la selection de l'atelier` et descend vers les quatre produits reels.
...
- La Creation Aigue-marine reste la Creation du moment.
...
Parcours cible a specifier :

1. le visiteur ouvre un popup premium `Entrez dans le Cercle MilAura` ;
2. il choisit et gratte une carte ;
3. un avantage reel et economiquement controle est revele ;
4. il renseigne son prenom et son email pour recevoir et activer cet avantage ;
5. son profil rejoint le Cercle avec un consentement marketing explicite ;
6. l'avantage est rattache au profil, idealement avec un code unique ou une regle non partageable massivement.

Le grattage doit avoir une alternative accessible de type `Reveler ma carte`.

Les recompenses possibles restent a chiffrer : remise avec minimum d'achat, livraison, cadeau ou credit futur. Aucune recompense ne doit etre definie avant le P&L.
...
H1A et H1B sont publies. Commencer par la reconciliation Git, sans reset, clean, pull global ou push complet du theme. Le commit de publication doit rester limite aux sept fichiers live et aux documents de verite.
