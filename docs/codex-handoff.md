...
La route permanente `/collections/selection-automne` renvoie encore 404 parce que la collection Shopify Admin n est pas creee. Prochaine gate : GO visuel Patrice sur la landing, puis creation Admin de la collection, affectation du template `selection-automne`, title SEO, meta description, canonical, sitemap et recommandations complementaires. Aucun live, Admin, Ads ou Pinterest n a ete modifie dans ce lot. Manifeste : `docs/campaigns/automne/manifest.md`. Checkpoint : `docs/checkpoints/2026-09-22-1940-autumn-landing-private.md`.
