> Reprise prioritaire, 2026-09-14 15:03 CEST : Hero accueil aigue-marine live et valide. L ancien Hero avec Chloé est preserve et s appelle exactement `HERO CHLOE` dans l editeur Shopify. Si Patrice dit `Creons cette page et reutilisons le HERO CHLOE.`, commencer en lecture seule, identifier le template de la page a creer, puis ajouter cette section sans modifier le Hero de l accueil. Aucun nettoyage Git, worktree ou preview sans demande distincte. Theme live `190430282075`, commits `509ed8e2`, `c29ae504`, `e60effeb`, `a956bc69`, pullbacks conformes. [Handoff complet](checkpoints/2026-09-14-1503-aquamarine-hero-live-handoff.md).
