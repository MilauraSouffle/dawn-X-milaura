> Menu Guides, 2026-09-12 19:29 CEST : AJUSTEMENT LIVE TERMINE. Les trois nouvelles ressources pierre sont groupees en tete de `Guides` sur desktop et mobile : `Trouver votre pierre`, `Atlas des pierres`, `Entretien des pierres`. Source et integration poussees, commit fonctionnel `9acd623a`, un seul snippet deploye sur `190430282075` puis relu a l identique. Les trois liens ont ete ouverts depuis le menu mobile et le menu desktop a ete controle visuellement. Aucun autre menu, footer, diagnostic, page ou Ads modifie. [Checkpoint](checkpoints/2026-09-12-1929-guides-menu-stone-pages-live.md).

> Actifs proprietaires pierre, 2026-09-12 19:12 CEST : LOT FERME, INTEGRE, POUSSE ET LIVE VERIFIE. Les pages `/pages/trouver-votre-pierre`, `/pages/entretien-des-pierres` et `/pages/atlas-des-pierres` sont visibles avec leurs templates et metas. La page canonique `/pages/pierres-de-naissance` conserve son contenu et utilise le Hero a trois bracelets valide par Patrice. Theme live `190430282075`, push cible 20 fichiers, pullback `20/20`, QA publique 390/1440 et interactions conformes, quatre reponses `200`, trois nouvelles URL dans le sitemap. Ne redeployer aucun fichier par deduction. La prochaine discussion peut cadrer un quiz Ads lead-gen distinct, sans deduire consentement, remise, automatisation, campagne ou budget. [Checkpoint final](checkpoints/2026-09-12-1912-owned-stone-assets-live.md).
