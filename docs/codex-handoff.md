...
```text
Reprends la landing Automne depuis docs/checkpoints/2026-09-22-1940-autumn-landing-private.md. Le theme prive 200259043675 contient la landing Grenat et Cornaline sur le template collection.selection-automne. Le moteur commun est sections/milaura-sodalite-landing.liquid, generalise sans duplication. Commence en lecture seule et verifie le GO visuel de Patrice. Si le GO est acquis, demande la gate Admin avant de creer /collections/selection-automne, lui affecter le template, regler title et meta, puis verifier canonical et sitemap. Les deux produits grenat 8 mm encore en HTTP 404 restent exclus. Aucun live, Ads, Pinterest ou recommandations Admin sans les gates distinctes.
```
