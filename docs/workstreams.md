...
Derniere mise a jour : 2026-08-13 18:29 CEST
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Polish homepage Selection d'aout : filet bas pleine largeur, carte transparente et controles soulignes | Codex, tache `Design UI MilAura` | `codex/milaura-home-seasonal-card-polish-20260813`, commit `33c821fc` | `/Users/paesano/Documents/MilAura website/_worktrees/home-seasonal-card-polish-20260813` | `sections/milaura-selection-atelier.liquid`, `assets/milaura-section-heading.css`, checkpoint `2026-08-13-1821` | developpement `199421952347`, pullback 2/2 ; live intact | deuxieme proposition, pret a valider visuellement | 2026-08-13 18:29 CEST |
