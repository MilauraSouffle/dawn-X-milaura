...
Hotfix live et controle. Le handoff inventaire concurrent a ete committe dans `885269c0` avant l integration. Le hotfix a ensuite ete fusionne dans `codex/milaura-integration` en conservant la documentation et la ligne de registre des deux lots.
